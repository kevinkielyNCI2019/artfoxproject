...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { artist_id: @artwork.artist_id, cat: @artwork.cat, desc: @artwork.desc, imageurl: @artwork.imageurl, price: @artwork.price, sold: @artwork.sold, title: @artwork.title } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { artist_id: @artwork.artist_id, cat: @artwork.cat, desc: @artwork.desc, imageurl: @artwork.imageurl, price: @artwork.price, sold: @artwork.sold, title: @artwork.title } }
